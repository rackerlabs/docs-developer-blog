...
<ol start=5>
    <li>After you have removed the robot, click **Start MHVTL**.</li>

    <li>Next, click **Setup** in the left navigation pane, then click **Add >
        Standard**. These steps initiate the setup wizard.</i>

    <li>Click **Next** to begin working with the wizard.</li>
</ol>
...
<ol start=2>
    <li>After you've entered all of the details, click the **Submit** button, then
        click **Finish** twice. Finally, click **Return**.</li>

    <li>Select **Console** in the left navigation pane and click the **Start**
        button to start the MHVTL engine.</li>
...
<ol start=2>
    <li>Select **Element Slot** and **Drive**.</li>
</ol>
