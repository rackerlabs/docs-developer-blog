---
layout: post
title: "Data Pump Enhancements (EXPDP) to Oracle Database 12c"
...
In this two-part blog series, we cover the changes to Oracle&reg; Data Pump
Export (EXPDP) technology and how to take exports of components of
your database architecture.

![An architectural diagram of Oracle
Data Pump]({% asset_path 2018-08-30-datapump1/picture1.png %})

The examples in this post focus on the Data Pump export in the context of a
_container database_ (CDB), which holds the Oracle metadata, and a _pluggable database_ (PDB), which holds your actual data.
...
When we try to take a full export, EXPDP only takes an export of the objects
...
Pump 12c's new features to export data more easily. In Part 2, we'll cover Data
Pump's restrictions on PDBs and how to export these databases.

### References

The following document was used as a reference for this blog post:

https://docs.oracle.com/database/121/SUTIL/GUID-F4EE2A42-3986-4597-9088-A506173ABABF.htm#SUTIL4298
