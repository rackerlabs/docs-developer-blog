...
Oracle&reg; Database versions 12.1.0.1 and 12.1.0.2. Part 1 covers version
12.1.0.1.
...
**Changing the PGA\_AGGREGATE_LIMIT\ parameter**
...
dimensions. You can also send the reports to others users who can view them
offline.
